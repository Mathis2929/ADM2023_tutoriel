...
```
# abondance des phylla ici la moitié est représenté par les Alphaprotéobactéries
...
# ecodist::MRM (physeq_clr_dist_square ~ envdata + ANF_km_dist_square, nperm=100) # 0.366
```

```{r, echo=FALSE}
# ecodist :: MRM(physeq_clr_dist_square ~ envdata, nperm=100) 
# 0.212
```
