...
# 1ere etape de normalisation (soit par rarefaction = prendre en compte qu’on a un nombre différentes de sequences, soit par fraction, ou par une méthode statistique)
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->

``` r
# on défini la seed pour un échantillonage aléatoire

set.seed(10000)

# nombre minimum de lecture pour un échantillonage
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
\# abondance des phylla ici la moitié est représenté par les
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->
...
# Indice de betadiveersité –\> JACCARD
...
# unifrac indice de beta div qui ponderer l’abondance relative des asb par leurs distance génétique
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-34-1.png)<!-- -->

# On peut aussi faire du clustering hierarchique.
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-36-1.png)<!-- -->
\# Compliqué
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-38-1.png)<!-- -->
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-39-1.png)<!-- -->
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-40-1.png)<!-- -->
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-40-2.png)<!-- -->
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-43-1.png)<!-- -->
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-48-1.png)<!-- -->
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-50-1.png)<!-- -->
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-51-1.png)<!-- -->

``` r
# On prepare la table ASV pour ajouter la taxonomie
tax_CLR <-  as.data.frame(tax_table(physeq_clr)) # Obtention de la table
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-52-1.png)<!-- -->
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-55-1.png)<!-- -->
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-56-1.png)<!-- -->
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-57-1.png)<!-- -->
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-59-1.png)<!-- -->
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-61-1.png)<!-- -->
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-62-1.png)<!-- -->

``` r
# Correlation avec les données environmentales
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-65-1.png)<!-- -->
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-68-1.png)<!-- -->

``` r
#On effectue un test Permanova sur les variables continues
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-73-1.png)<!-- -->
...
# On analyse ensuite les similarités
...
``` r
# Preparation des données pour le plot
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-87-1.png)<!-- -->
...
# Calcul du modele afin ensuite de faire le plot
...
# Il y a un erreur ici que je n’arrive pas à résoudre, même en téléchargeant les bons packages il y a apparition de l’erreur “error in xj\[i,, drop = FALSE\] cependant je peux quand même faire le plot qui me donnera le regroupement.
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-92-1.png)<!-- -->

``` r
# betapart::plot.decay(ANF_decay_exp,
                    # col = "blue",
                    # remove.dots = TRUE,
                    # add = TRUE)
```

# Comme je n’ai pas pu créer l’objet ANF_decay_exp ce chunk ne peut pas fonctionner
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-99-1.png)<!-- -->
...
# Il y a différentes technique d’analyse d’abondance. Dans notre cas, on va utiliser LEFSE.
...
```
    ...
    ## marker1    ASV11        North 4.732200 0.0015574784 0.0015574784
    ## marker2    ASV12        North 4.689307 0.0045142882 0.0045142882
    ## marker3    ASV10        North 4.633584 0.0022950748 0.0022950748
    ## marker4    ASV18        North 4.433076 0.0045142882 0.0045142882
    ## marker5    ASV35        North 4.190834 0.0045142882 0.0045142882
    ## marker6     ASV2        South 4.955554 0.0039173223 0.0039173223
    ## marker7     ASV7        South 4.672289 0.0010275895 0.0010275895
    ## marker8     ASV8        South 4.659449 0.0020814438 0.0020814438
    ## marker9     ASV3        South 4.410467 0.0091897421 0.0091897421
    ## marker10   ASV27        South 4.358686 0.0008112059 0.0008112059
    ## marker11   ASV13        South 4.327668 0.0073724319 0.0073724319
...
![](TD02_betadiversité_files/figure-gfm/unnamed-chunk-101-1.png)<!-- -->
...
```
    ...
    ## marker1   ASV27        North 1.785232 0.0004326893 0.03172943
